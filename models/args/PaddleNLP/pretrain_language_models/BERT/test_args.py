...
pretrain = {
           ...
           "bert_config_path": ["args_test_model/chinese_L-12_H-768_A-12/bert_config.json"],
...
finetune_cls = {
           ...
           "init_pretraining_params": ["args_test_model/chinese_L-12_H-768_A-12/params", "None"],
...
finetune_squad = {
           ...
           "batch_size": [12],
           "in_tokens": [False],
           "init_pretraining_params": ["args_test_model/chinese_L-12_H-768_A-12/params"],
           "checkpoints": ["args_test_output"],
           "vocab_path": ["args_test_model/chinese_L-12_H-768_A-12/vocab.txt"],
           "do_train": [True],
           "do_predict": [True],
