...
def inference_yolov3_darknet53(img, model_path, params_path, with_ir=True):
    """
    inference_ttfnet
    Args:
        img: numpy img
...
def test_yolov3_darknet53():
    ...
    no_ir_data = inference_yolov3_darknet53(img, model_path, params_path, with_ir=False)
    ...
    # image_path, with_lr_data[0], save_name="yolov3_darknet53.jpg")
