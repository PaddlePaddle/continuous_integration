...
def inference_ssd_mobilenet(img, model_path, params_path, with_ir=True, use_trt=True):
    """
    inference_ttfnet
    Args:
        img: numpy img
...
def test_ssd_mobilenet():
    ...
    no_ir_data = inference_ssd_mobilenet(img, model_path, params_path, with_ir=False, use_trt=False)
