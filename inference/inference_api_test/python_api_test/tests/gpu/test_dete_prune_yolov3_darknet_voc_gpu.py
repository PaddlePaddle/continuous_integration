...
class TestDetePruneYoloDarknetVocInferenceGPU(TestModelInferenceGPU):
    """
    ...
    def test_inference_dete_prune_yolov3_darknet_voc_gpu(self):
        """
        Inference and check value
        dete_prune_yolov3_darknet_voc gpu model
        Args:
            None
        Return:
            None
        """
        model_name = "dete_prune_yolov3_darknet_voc_combined"
