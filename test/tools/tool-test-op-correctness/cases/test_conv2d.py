...
def test_conv2d1():
    ...
    stride = 1
    padding = 0
    res = np.array([[[[5.6780, 3.9777, 4.8305], [4.8986, 5.0738, 5.9837],
                      [5.1103, 7.2506, 7.0629]]],
                    [[[5.2631, 5.0306, 6.2066], [7.6067, 5.8608, 5.8187],
...
def test_conv2d2():
    ...
    res = np.array([[[[5.6780, 3.9777, 4.8305], [4.8986, 5.0738, 5.9837],
                      [5.1103, 7.2506, 7.0629]],
                     [[5.6780, 3.9777, 4.8305], [4.8986, 5.0738, 5.9837],
                      [5.1103, 7.2506, 7.0629]], [[5.6780, 3.9777, 4.8305],
                                                  [4.8986, 5.0738, 5.9837],
                                                  [5.1103, 7.2506, 7.0629]]],
                    [[[5.2631, 5.0306, 6.2066], [7.6067, 5.8608, 5.8187],
                      [7.2613, 6.7396, 6.0788]],
                     [[5.2631, 5.0306, 6.2066], [7.6067, 5.8608, 5.8187],
                      [7.2613, 6.7396, 6.0788]], [[5.2631, 5.0306, 6.2066],
...
def test_conv2d4():
    ...
    stride = 2
    padding = 1
    res = np.array([[[[5.6780, 6.7046], [7.8561, 13.2501]]],
                    [[[5.2631, 8.0467], [10.6586, 13.6606]]]])
    obj.run(res=res,
            data=x,
            in_channels=in_channels,
            out_channels=out_channels,
...
def test_conv2d5():
    ...
    padding = 0
    groups = 3
    res = np.array([[[[4.3166]], [[4.3166]], [[4.6029]], [[4.6029]], [[3.6437]],
                     [[3.6437]]], [[[3.6364]], [[3.6364]], [[5.5694]],
                                   [[5.5694]], [[5.2870]], [[5.2870]]]])
    obj.run(res=res,
            data=x,
            in_channels=in_channels,
            out_channels=out_channels,
...
def test_conv2d6():
    ...
    stride = 1
    padding = 0
    res = np.array([[[[8.4943, 7.2061], [9.0308, 8.9750]], [[8.4943, 7.2061],
                                                            [9.0308, 8.9750]]],
                    [[[9.8450, 8.4803], [10.3186, 9.2624]],
                     [[9.8450, 8.4803], [10.3186, 9.2624]]]])
    obj.run(res=res,
            data=x,
            in_channels=in_channels,
