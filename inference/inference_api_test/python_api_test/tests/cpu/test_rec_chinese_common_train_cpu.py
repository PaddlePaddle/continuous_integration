...
class TestRecChineseCommonTrainInferenceCPU(TestModelInferenceCPU):
    """
    ...
    def test_inference_rec_chinese_common_train_cpu(self):
        """
        Inference and check value
        rec_chinese_common_train cpu model
        Args:
            None
        Return:
            None
