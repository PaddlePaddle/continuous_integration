...
run_classifier = {
        ...
        "vocab_path": ["./args_test_senta_data/word_dict.txt", "./args_test_senta_data_1/word_dict.txt"],
...
run_ernie_classifier = {
        ...
        "ernie_config_path": ["./args_test_senta_model/ernie_pretrain_model/ernie_config.json"],
        "train_set": ["./args_test_senta_data/train.tsv", "./args_test_senta_data_1/train.tsv"],
        "test_set": ["./args_test_senta_data/test.tsv", "./args_test_senta_data_1/test.tsv"],
        "dev_set": ["./args_test_senta_data/dev.tsv", "./args_test_senta_data_1/dev.tsv"],
        "max_seq_len": [256],
