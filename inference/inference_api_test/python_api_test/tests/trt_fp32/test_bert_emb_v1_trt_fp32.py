...
input_tensor_names = ['src_ids', 'pos_ids', 'sent_ids',
                      'matmul_0.tmp_0']  # after trt update
...
@pytest.mark.p2
def test_inference_bert_emb_v1_trt_fp32():
    """
    ...
    tmp_path = os.path.join(TestBase.model_root, "hub-ernie")
