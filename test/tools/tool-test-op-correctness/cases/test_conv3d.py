...
def test_conv3d_base():
    ...
    stride = 1
    padding = 0
    res = np.array([[[[[41.1337, 38.3068], [43.4962, 41.8764]],
                      [[40.5446, 35.9235], [44.1236, 39.3930]]]],
                    [[[[41.1783, 40.6048], [38.8515, 39.3217]],
                      [[41.8694, 41.8558], [43.3938, 43.9873]]]]])
    obj.base(
        res=res,
        data=x,
...
def test_conv3d1():
    ...
    padding = 0
    res = np.array(
        [[[[[10.2772, 10.1530, 10.9078], [12.0972, 12.3482, 12.6883],
            [13.0722, 14.6254, 14.2059]],
           [[11.2427, 9.8658, 11.5452], [11.5212, 11.6108, 11.7400],
            [13.3817, 14.1561, 12.6881]], [[11.5497, 9.8221, 12.0690],
                                           [13.6953, 11.9212, 10.5904],
                                           [13.2860, 12.9401, 10.7971]]]],
         [[[[13.4966, 12.8346, 13.3530], [12.6845, 9.6804, 11.3862],
            [10.7447, 8.5911, 11.7397]],
           [[12.2808, 13.5631, 13.3528], [11.8886, 11.2349, 11.0825],
            [11.7111, 11.3234, 12.9307]], [[10.5355, 13.3375, 14.5260],
...
def test_conv3d4():
    ...
    stride = 2
    padding = 1
    res = np.array([[[[[10.2772, 15.2571], [18.2521, 28.5663]],
                      [[16.8695, 23.1947], [28.9226, 39.3930]]]],
                    [[[[13.4966, 20.3464], [17.3102, 24.9590]],
                      [[16.9992, 30.4095], [29.0104, 43.9873]]]]])
    obj.run(res=res,
            data=x,
            in_channels=in_channels,
            out_channels=out_channels,
...
def test_conv3d5():
    ...
    padding = 0
    groups = 3
    res = np.array([[[[[12.5633]]], [[[12.5633]]], [[[16.0763]]], [[[16.0763]]],
                     [[[12.4942]]], [[[12.4942]]]],
                    [[[[14.2857]]], [[[14.2857]]], [[[15.0920]]], [[[15.0920]]],
                     [[[11.8007]]], [[[11.8007]]]]])
    obj.run(res=res,
            data=x,
            in_channels=in_channels,
...
def test_conv3d6():
    ...
    stride = 1
    padding = 0
    res = np.array([[[[[28.4936, 26.5148], [30.1473, 29.0135]],
                      [[28.0812, 24.8464], [30.5865, 27.2751]]],
                     [[[28.4936, 26.5148], [30.1473, 29.0135]],
                      [[28.0812, 24.8464], [30.5865, 27.2751]]]],
                    [[[[28.5248, 28.1234], [26.8961, 27.2252]],
                      [[29.0086, 28.9991], [30.0757, 30.4911]]],
                     [[[28.5248, 28.1234], [26.8961, 27.2252]],
                      [[29.0086, 28.9991], [30.0757, 30.4911]]]]])
    obj.run(res=res,
            data=x,
