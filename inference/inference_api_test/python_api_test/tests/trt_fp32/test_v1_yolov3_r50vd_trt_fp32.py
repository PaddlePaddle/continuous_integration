...
def inference_yolov3_r50vd(img, model_path, params_path, with_ir=True, use_trt=True):
    """
    inference_ttfnet
    Args:
        img: numpy img
...
def test_yolov3_r50vd():
    ...
    no_ir_data = inference_yolov3_r50vd(img, model_path, params_path, with_ir=False, use_trt=False)
    ...
    # image_path, with_lr_data[0], save_name="yolov3_r50vd.jpg")
