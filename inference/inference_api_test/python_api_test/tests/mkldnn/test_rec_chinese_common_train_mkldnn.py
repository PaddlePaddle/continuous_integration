...
class TestRecChineseCommonTrainInferenceMKLDNN(TestModelInferenceMKLDNN):
    """
    ...
    def test_inference_rec_chinese_common_train_mkldnn(self):
        """
        Inference and check value
        rec_chinese_common_train mkldnn model
        Args:
            None
        Return:
            None
