...
cpu_math_library_num_threads: ${cpu_math_library_num_threads}${NC} \n"
            log_path="${log_root}/use_mkldnn_${use_mkldnn}/tids_${cpu_math_library_num_threads}"
            mkdir -p ${log_path}
...
main(){
    ...
    model_root="/workspace/inference/inference_benchmark/Paddle/Data/Paddle"
    ...
    # unet-paddle
    # models="unet-paddle"
    # predict_cpu clas_benchmark ${models} ${model_root}/${models} "" "1,512,512"
    ...
    # models="HRNet_W18_C"
    # predict_cpu clas_benchmark ${models} ${model_root}/${models}/__model__ "${model_root}/${models}/__params__" 
