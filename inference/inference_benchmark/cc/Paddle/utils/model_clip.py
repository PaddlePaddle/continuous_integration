...
def parse_args():
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="./input_inference_model",
        help="input model path prefix")
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_model_path",
        type=str,
        default="./output_inference_model/inference",
        help="output model path prefix")
    return parser.parse_args()


def clip_model_extra_op(path_prefix=None,
                        model_dir=None,
    ...
    paddle.static.save_inference_model(
        ...
        clip_extra=True)
    print(
        "==== extra op attributes have been clipped from inference program ====")
    print("==== op attribute cliped model has been saved to {0}".format(
        output_model_path))
