...
def inference_yolov3_mobilenet_v1(img, model_path, params_path, with_ir=True, use_trt=True):
    """
    inference_ttfnet
    Args:
        img: numpy img
...
def test_yolov3_mobilenet_v1():
    ...
    no_ir_data = inference_yolov3_mobilenet_v1(img, model_path, params_path, with_ir=False, use_trt=False)
