...
def test_tensor_bitwise_xor1():
    ...
    input.type=bool
    """
    x = np.arange(-1, 2 * 3 * 3 * 3 * 4 * 1 * 5 * 2 - 1).reshape(
        2, 3, 3, 3, 4, 1, 5, 2).astype(np.bool)
...
def test_tensor_bitwise_xor2():
    ...
    """
    x = np.arange(-1, 2 * 3 * 3 * 3 * 4 * 1 * 5 * 2 - 1).reshape(
        2, 3, 3, 3, 4, 1, 5, 2).astype(np.uint8)
...
def test_tensor_bitwise_xor3():
    ...
    """
    x = np.arange(-1, 2 * 3 * 3 * 3 * 4 * 1 * 5 * 2 - 1).reshape(
        2, 3, 3, 3, 4, 1, 5, 2).astype(np.int8)
...
def test_tensor_bitwise_xor4():
    ...
    """
    x = np.arange(-1, 2 * 3 * 3 * 3 * 4 * 1 * 5 * 2 - 1).reshape(
        2, 3, 3, 3, 4, 1, 5, 2).astype(np.int16)
...
def test_tensor_bitwise_xor5():
    ...
    """
    x = np.arange(-1, 2 * 3 * 3 * 3 * 4 * 1 * 5 * 2 - 1).reshape(
        2, 3, 3, 3, 4, 1, 5, 2).astype(np.int32)
...
def test_tensor_bitwise_xor6():
    ...
    """
    x = np.arange(-1, 2 * 3 * 3 * 3 * 4 * 1 * 5 * 2 - 1).reshape(
        2, 3, 3, 3, 4, 1, 5, 2).astype(np.int64)
