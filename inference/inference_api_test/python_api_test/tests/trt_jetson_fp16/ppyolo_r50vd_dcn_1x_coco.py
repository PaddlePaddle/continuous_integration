...
def parse_args():
    ...
    parser.add_argument("--model_file",default='../../Data/det_inference_model/ppyolo_r50vd_dcn_1x_coco/model.pdmodel' ,type=str, help="model filename")
    parser.add_argument("--params_file", default='../../Data/det_inference_model/ppyolo_r50vd_dcn_1x_coco/model.pdiparams',type=str, help="parameter filename")
...
if __name__ == "__main__":
    ...
    try:
        ...
        os.system('echo "TensorRT FP16 ppyolo_r50vd_dcn_1x_coco inference error" >> log.txt')
    else:
        max_diff = np.max(np.abs(data - ir_optim_data))
        if max_diff < 1e-6:
            print('TensorRT FP16 ppyolo_r50vd_dcn_1x_coco ok')
        else:
            print('TensorRT FP16 ppyolo_r50vd_dcn_1x_coco failed, diff is ', max_diff)
            os.system('echo "TensorRT FP16 ppyolo_r50vd_dcn_1x_coco failed,diff is "' + str(max_diff) + '>> log.txt')
